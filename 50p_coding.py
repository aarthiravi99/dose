...
In this simulation,
    ...
    W, X, Y, Z, 0) where A to M are the 26 beneficial genes, N to Z 
    are the 26 detrimental genes and 0 is the neutral gene.
    - each genome will be 20x repeat of "ABCDEFGHIJKLM0000000000000NO
    PQRSTUVWXYZ0000000000000", totally 1040 gene space with 25% 
    beneficial genes, 25% detrimental genes and 50% empty gene space.
...
initial_chromosome = \
    "ABCDEFGHIJKLM0000000000000NOPQRSTUVWXYZ0000000000000" * 20
