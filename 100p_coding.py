...
- each genome will be 20x repeat of the 52 coding and non-coding gene spaces in "ABCDEFGHIJKLMABCDEFGHIJKLMNOPQRSTUVWXYZNOPQRSTUVWXYZ", 
    totally 1040 gene space with 100% coding density- 50% beneficial genes, 50% detrimental genes 
    (13 each of beneficial and detrimental genes, 26 copies each of beneficial and detrimental genes) 
    and 0% (0 copies) of non-coding gene space.
- 1% background point mutation on chromosome
- geneList refers to probability of mutation type, 
    beneficial-detrimental-neutral have equal probability of 33% mutability to self or other type of gene, 
...
beneficial_gene = [gene for gene in "ABCDEFGHIJKLMABCDEFGHIJKLM"]

detrimental_gene = [gene for gene in "NOPQRSTUVWXYZNOPQRSTUVWXYZ"]

initial_chromosome = \
    "ABCDEFGHIJKLMABCDEFGHIJKLMNOPQRSTUVWXYZNOPQRSTUVWXYZ" * 20
...
parameters = {# Part 1: Simulation metadata
              "simulation_name": "100 percent codings",
